...
- As pendências detalhadas estão em [pendencias_reais.md](pendencias_reais.md) (visão progressiva) e [pendencias_humanas.md](pendencias_humanas.md) (dados que dependem das pessoas do time).
