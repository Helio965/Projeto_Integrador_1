...
- **Plano/Registro de Testes Funcionais** — ainda não há arquivo dedicado no repositório.
...
Materiais que **não** devem ser publicados neste repositório e devem ir apenas pelo canal oficial (Sala Online/AVA), se solicitados:
