...
| RF06 | Controle de plano | O sistema deve registrar o plano da empresa (BRONZE, PRATA ou OURO). |
| RF07 | Regra de periodicidade por plano | A criação de análise quinzenal deve ser permitida apenas para empresas do plano OURO, como regra de negócio na aplicação. |
