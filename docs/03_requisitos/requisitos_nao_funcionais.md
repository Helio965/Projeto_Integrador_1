# Requisitos Não Funcionais — NEXO
...
| RNF03 | Desempenho | O processamento de um relatório e a geração dos indicadores devem ocorrer em tempo adequado ao uso acadêmico/demonstração. Meta de tempo específica: pendente de definição pela equipe. |
...
| RNF07 | Clareza visual | Os dashboards (Plotly.js) devem apresentar os indicadores de forma legível e compreensível. |
| RNF08 | Disponibilidade local/acadêmica | A aplicação deve poder ser executada em ambiente local para fins de demonstração da disciplina. |
| RNF09 | Privacidade | Documentos sensíveis e dados pessoais não devem ser versionados em repositório público. |
