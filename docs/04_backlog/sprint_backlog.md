...
> Distribuição de responsáveis e estimativas a serem confirmadas pela equipe ao longo das sprints.

## Sprint 1

- **Objetivo da Sprint:** Estruturar a base do sistema — autenticação, perfis de usuário, cadastros base e modelo de dados.
- **Período:** Pendente de inclusão pela equipe.
...
- **Objetivo da Sprint:** Implementar criação de análise, upload de relatórios, ETL, geração de indicadores e dashboard.
- **Período:** Pendente de inclusão pela equipe.
